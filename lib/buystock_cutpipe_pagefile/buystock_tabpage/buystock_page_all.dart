...
import 'package:stock_product_app/buystock_cutpipe_pagefile/buystock_tabpage/buystock_page_ab.dart';
...
import 'package:stock_product_app/buystock_cutpipe_pagefile/buystock_tabpage/buystock_page_sam.dart';
...
class buystock_page_all extends StatefulWidget {
  const buystock_page_all({Key? key}) : super(key: key);

  @override
  State<buystock_page_all> createState() => _buystock_page_allState();
}

class _buystock_page_allState extends State<buystock_page_all> {

  Future<List<GetallbuystockAll>>? getAllbuystockAllData;
  final date = new DateFormat('dd/MM/yyyy');
  List listBuystockAllData = [];

  get index => context;
  getpsd() {
    setState(() {
      getAllbuystockAllData = GetbuystockAPI.getviewAllbuystockAll();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(
          child: FutureBuilder(
            future: getAllbuystockAllData,
            builder: (BuildContext context , AsyncSnapshot snapshot) {
              if (snapshot.connectionState == ConnectionState.done && snapshot.hasData) {
                print(snapshot.data.length);
                listBuystockAllData = snapshot.data;
                print('BuystockAll');
