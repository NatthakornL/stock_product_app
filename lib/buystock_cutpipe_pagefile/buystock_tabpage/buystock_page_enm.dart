...
class buystock_page_enm extends StatefulWidget {
  const buystock_page_enm({Key? key}) : super(key: key);

  @override
  State<buystock_page_enm> createState() => _buystock_page_enmState();
}

class _buystock_page_enmState extends State<buystock_page_enm> {

  Future<List<GetallbuystockENM>>? getAllbuystockENMData;
  final date = new DateFormat('dd/MM/yyyy');
  List listBuystockENMData = [];

  get index => context;
  getpsd() {
    setState(() {
      getAllbuystockENMData = GetbuystockAPI.getviewAllbuystockENM();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(
          child: FutureBuilder(
            future: getAllbuystockENMData,
            builder: (BuildContext context , AsyncSnapshot snapshot) {
              if (snapshot.connectionState == ConnectionState.done && snapshot.hasData) {
                print(snapshot.data.length);
                listBuystockENMData = snapshot.data;
                print('BuystockENM');
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: OutlinedButton(
                                    style: OutlinedButton.styleFrom(
                                      backgroundColor: Color(0xff6EC100),
                                    ...
                                    onPressed: () {
                                      ...
                                      //     context,
                                      //     MaterialPageRoute(
                                      //         builder: (context) => buystock_page_all()),
                                      // );
                                    },
                                  ),
                                ),  //Engine
