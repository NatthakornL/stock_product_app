...
class buystock_page_cb extends StatefulWidget {
  const buystock_page_cb({Key? key}) : super(key: key);

  @override
  State<buystock_page_cb> createState() => _buystock_page_cbState();
}

class _buystock_page_cbState extends State<buystock_page_cb> {

  Future<List<GetallbuystockCB>>? getAllbuystockCBData;
  final date = new DateFormat('dd/MM/yyyy');
  List listBuystockCBData = [];

  get index => context;
  getpsd() {
    setState(() {
      getAllbuystockCBData = GetbuystockAPI.getviewAllbuystockCB();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(
          child: FutureBuilder(
            future: getAllbuystockCBData,
            builder: (BuildContext context , AsyncSnapshot snapshot) {
              if (snapshot.connectionState == ConnectionState.done && snapshot.hasData) {
                print(snapshot.data.length);
                listBuystockCBData = snapshot.data;
                print('BuystockCB');
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: OutlinedButton(
                                    style: OutlinedButton.styleFrom(
                                      backgroundColor: Color(0xff00A3C1),
