...
class buystock_page_sam extends StatefulWidget {
  const buystock_page_sam({Key? key}) : super(key: key);

  @override
  State<buystock_page_sam> createState() => _buystock_page_samState();
}

class _buystock_page_samState extends State<buystock_page_sam> {

  Future<List<GetallbuystockSAM>>? getAllbuystockSAMData;
  final date = new DateFormat('dd/MM/yyyy');
  List listBuystockSAMData = [];

  get index => context;
  getpsd() {
    setState(() {
      getAllbuystockSAMData = GetbuystockAPI.getviewAllbuystockSAM();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(
          child: FutureBuilder(
            future: getAllbuystockSAMData,
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (snapshot.connectionState == ConnectionState.done && snapshot.hasData) {
                print(snapshot.data.length);
                listBuystockSAMData = snapshot.data;
                print('BuystockSAM');
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: OutlinedButton(
                                    style: OutlinedButton.styleFrom(
                                      backgroundColor: Color(0xff6A00C1),
