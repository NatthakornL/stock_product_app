...
try {
    if (isset($_GET['searchText']) && isset($_GET['page']) && isset($_GET['pageSize'])) {
        ...
        $result['dataCount'] = ProductManufactureModel::getManufactureDoneSearchCount($_GET['searchText']);
        $result['pagination'] = round($result['dataCount'] / $result['pageSize']);
        $result['data'] = ProductManufactureModel::getManufactureDoneSearch($_GET['searchText'], $OFFSET, $result['pageSize']);
