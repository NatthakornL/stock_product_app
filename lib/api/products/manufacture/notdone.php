...
try {
    if (isset($_GET['page']) && isset($_GET['pageSize'])) {
        ...
        $result['dataCount'] = ProductManufactureModel::getManufactureNotDoneCount();
        $result['pagination'] = round($result['dataCount'] / $result['pageSize']);
        $result['data'] = ProductManufactureModel::getManufactureNotDonePagination($OFFSET, $result['pageSize']);
