...
try {
    if (isset($_GET['page']) && isset($_GET['pageSize'])) {
        ...
        $result['dataCount'] = ProductManufactureModel::getManufactureDoneCount();
        $result['pagination'] = round($result['dataCount'] / $result['pageSize']);
        $result['data'] = ProductManufactureModel::getManufactureDonePagination($OFFSET, $result['pageSize']);
